...
describe('FileReader', () => {
  ...
  describe('readAsText', () => {
    ...
    it('should fire loadstart event', () =>
      new Promise<void>((done) => {
    ...
    it('should fire loadend event after load', () =>
      new Promise<void>((done) => {
        let loadFired = false;
        fileReader.onload = () => {
          loadFired = true;
    ...
    it('should throw error when already loading', () => {
      fileReader.readAsText(testBlob);
      expect(() => fileReader.readAsText(testBlob)).toThrow(
        'The FileReader is already reading',
      );
    });
  });

  describe('readAsArrayBuffer', () => {
    it('should read ArrayBuffer from blob', () =>
      new Promise<void>((done) => {
        fileReader.onload = (event) => {
  ...
  describe('readAsDataURL', () => {
    it('should read data URL from blob', () =>
      new Promise<void>((done) => {
        fileReader.onload = (event) => {
          ...
          const decodedText = Buffer.from(base64Data, 'base64').toString(
            'utf-8',
          );
    ...
    it('should use default content type for blobs without type', () =>
      new Promise<void>((done) => {
  ...
  describe('readAsBinaryString', () => {
    it('should read binary string from blob', () =>
      new Promise<void>((done) => {
        fileReader.onload = (event) => {
          expect(typeof fileReader.result).toBe('string');
          const result = fileReader.result as string;
  ...
  describe('abort', () => {
    it('should abort loading operation', () =>
      new Promise<void>((done) => {
    ...
    it('should fire loadend after abort', () =>
      new Promise<void>((done) => {
  ...
  describe('Error handling', () => {
    it('should handle errors in read operation', () =>
      new Promise<void>((done) => {
    ...
    it('should fire loadend after error', () =>
      new Promise<void>((done) => {
        const errorBlob = {
          text: () => Promise.reject(new Error('Test error')),
          type: 'text/plain',
  ...
  describe('Progress events', () => {
    it('should fire progress event on successful read', () =>
      new Promise<void>((done) => {
